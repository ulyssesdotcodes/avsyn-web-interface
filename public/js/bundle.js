...
},{"react":159}],31:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"react":159,"react-slider":30,"underscore":160}],162:[function(require,module,exports){
"use strict";
...
var ProgList = React.createClass({
  ...
  render: function () {
    var progNodes = this.props.data.programs.map((name, index) => {
      ...
      return React.createElement(Program, { name: name, key: this.props.path.join('.') + "." + name,
...
var Program = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: selectedClass, onClick: this.props.onSelected },
      this.props.name
    );
  }
});
  ...
  render: function () {
    let cueNodes = _.values(_.mapObject(this.props.data.cues, (cue, name) => {
      ...
      return React.createElement(
        ...
        React.createElement(CueControls, props)
      );
    }));
...
},{"./Controls.js":161,"react":159,"underscore":160}],163:[function(require,module,exports){
"use strict";
...
var Mixer = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: 'mixer' },
      React.createElement(Vis, _extends({ key: "visA" }, visAProps)),
      React.createElement(MixerControls, _extends({ key: "controls" }, controlsProps)),
      React.createElement(Vis, _extends({ key: "visB" }, visBProps))
    );
  }
});

var MixerControls = React.createClass({
  displayName: 'MixerControls',
...
},{"./Controls":161,"./Vis.js":165,"react":159,"underscore":160}],164:[function(require,module,exports){
"use strict";
...
var Rpi = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement(
            'div',
            { className: 'rpi' },
            React.createElement(Controls.Toggle, { onChange: toggleAudioReactive, name: 'Audio Reactive', value: this.props.data.rpi.program == "audioReactive" }),
            React.createElement(Controls.Slider, { onChange: changeLightLevel, name: 'Light Level', defaultValue: 0, min: 0, max: 1 })
        );
    }
});
...
},{"./Controls.js":161,"react":159,"underscore":160}],165:[function(require,module,exports){
"use strict";
...
var Vis = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: 'choiceVisualization' },
      React.createElement(EffectsList, effectsListProps),
      React.createElement(VisualizationList, visualizationListProps),
      React.createElement(SlidersList, slidersListProps)
    );
  }
});

var VisualizationList = React.createClass({
  displayName: 'VisualizationList',
...
var VisualizationChoice = React.createClass({
  displayName: 'VisualizationChoice',
...
},{"./Controls.js":161,"react":159,"react-slider":30,"underscore":160}],166:[function(require,module,exports){
"use strict";
...
},{"./HoY.js":162,"./Mixer.js":163,"./Rpi.js":164,"react":159,"react-dom":29,"underscore":160}]},{},[166]);
