...
var Vis = React.createClass({
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(VisualizationList, { names: this.props.visualizationNames, onVisualizationSelected: this.props.onVisualizationSelected })
    );
  }
});
...
var VisualizationList = React.createClass({
  ...
  render: function () {
    var commentNodes = this.props.names.map((name, index) => {
      ...
      return React.createElement(VisualizationChoice, { name: name, key: index + name, index: index, onSelected: this.onVisualizationSelected,
        selected: selected });
    });
...
var VisualizationChoice = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: selectedClass, onClick: this.handleClick },
      this.props.name
    );
  }
});
...
var listeners = [];
var registerListener = _.partial(function (listeners, address, func) {
...
document.addEventListener("DOMContentLoaded", function (e) {
  ...
  ReactDOM.render(React.createElement(Vis, { name: 'visA', visualizationNames: testVisNames }), document.getElementById("visA"));
});
...
registerListener("/connection/choices", function (message) {
  ...
  ReactDOM.render(React.createElement(Vis, { name: 'visA', visualizationNames: message.args, onVisualizationSelected: onVisualizationSelected }), document.getElementById("visA"));
});

},{"./Vis.js":160,"react":158,"react-dom":2,"underscore":159}]},{},[161]);
